...
# Here we prepare our time series for various aggregations- 1-hour to 24 hour, 72 hour and 1 month, 
# following this we compute the reference statistics
...
# Computing the NSRP parameters requires reference_statistics as the key input
...
## Now we have the parameters computed and these parameters are what we pass to run our rainfall generator
n_realizations = 300
n_years = 80
base_seed = 42
...
## Plot to compare the realizations with observed
