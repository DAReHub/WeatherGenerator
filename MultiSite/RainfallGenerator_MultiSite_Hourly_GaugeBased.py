## This python script for multi-site NSRP based rainfall simulation can be grouped into 5 stages as seen for single site
...
## are mean, variance, skewness, autocorrelation, dry proportions and cross correlation
...
main_sim(spatial_model = True, intensity_distribution = 'weibull',
          output_types = ['point'],output_folder = '/home/users/DATA/Spatial_Inputs/Dee/REALIZATION_DEE_POINT',
          output_subfolders = {'point': ''},output_format = 'csv', season_definitions = SD,parameters = parameters_df,point_metadata = GMETA,
          catchment_metadata = None,grid_metadata = None,epsg_code = 27700, cell_size = None, dem = None, phi = PHIDF, simulation_length = 30,
          number_of_realisations = n_realizations, timestep_length = 1.0, start_year = ALLDF[1]['1H']['Year'].min(),calendar = 'gregorian', random_seed = 43, 
          default_block_size = block_size, check_block_size = True, minimum_block_size = 1, check_available_memory = True, maximum_memory_percentage = 90, 
          block_subset_size = GMETA.shape[0], project_name = 'DeeDistrict',spatial_raincell_method = 'buffer', spatial_buffer_factor = 15, 
          simulation_mode = 'no_shuffling', weather_model = None, max_dsl = 6,n_divisions = 8, do_reordering = True) 
